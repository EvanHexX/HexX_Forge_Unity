...
- Asset Manager → `src/renderer/pages/AssetManager.tsx`, `src/main/services/assetService.ts`, `src/main/services/assetPackService.ts`, `src/main/services/assetPatcherService.ts`, `src/main/ipc/assetIpc.ts`, `src/main/ipc/assetPackIpc.ts`, `src/main/ipc/assetPatcherIpc.ts`, `src/preload/preload.ts`, `asset-packs/index.json`, `docs/modules/asset-manager.md`
